# Known Issues 台账 — 已解决条目归档

> 原 `docs/KNOWN_ISSUES.md`（2026-06-10 建）于 2026-08-25 废除：未解决条目已迁至 GitHub Issues
> （标题带 `KNOWN_ISSUES #N`），此后问题一律走 Issues。本文件原样保留已解决条目，
> 供代码/测试注释中的 `KNOWN_ISSUES #N` 引用查阅。
